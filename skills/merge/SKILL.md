...
- **`scripts/merge.sh`** — merge the current feature branch into `main`, remove the temporary feature docs in the merge commit, and delete the merged branch

## Process

1. Read `docs/features/<feature-name>.md` and `docs/reviews/<feature-name>.md`. If either file does not exist, tell the user and stop.
